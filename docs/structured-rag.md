...
_Eval has not yet been executed on this machine. Run `python -m evals.structured_rag.runner` against the seeded `crm` schema to populate this section with current numbers — the runner emits a markdown fragment ready to drop in here._

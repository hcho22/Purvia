...
- [x] Seed script at `supabase/seed/crm_seed.py` is deterministic (fixed RNG seed) and produces ~200 customers across 5 countries, ~50 products across 5 categories, ~1000 orders with varied status/dates/amounts, ~3000 order_items, ~100 refunds
...
- **Steps:**
  ...
  2. Run `python -m supabase.seed.crm_seed`

...
| E — Support surface (US-067–093, beyond US-066) | 🟡 **In progress** | US-066 migration + US-067 (status-machine latch, PR #29), US-068 (JWT minting, PR #31), US-069 (bot provisioning, PR #32), US-070 (bot retrieval, PR #33), US-071 (opaque conversation token, PR #34) and US-072 (widget-key registry + not-revoked resolution gate, PR #35) have landed; the rest of the conversation/widget runtime (per-key CORS/origin allowlist, customer SSE, first-message flow, admin surface) and US-073–093 remain. |

...
| Rest of C–F | ⬜ Not started | No `escalation.py` / `conversations` migration exists; ingestion parser-boundary (C), structured-RAG (D/E as applicable), and remaining areas pending. |

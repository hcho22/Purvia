...
| E — Support surface (US-067–093, beyond US-066) | 🟡 **In progress** | US-066 migration + US-067 (status-machine latch, PR #29), US-068 (JWT minting, PR #31), US-069 (bot provisioning, PR #32), US-070 (bot retrieval, PR #33) and US-071 (opaque conversation token, PR #34) have landed; the conversation/widget runtime (widget keys + CORS, customer SSE, first-message flow, admin surface) and the rest of US-072–093 remain. |
